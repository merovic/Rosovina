                ...
                VStack{
                    ...
                    HStack{
                        Text("Price")
                            ...
                            .foregroundColor(Color("DarkGray"))
                        Spacer()
                        Text(String(viewModel.cartResponse?.subTotal ?? 0) + " " + (viewModel.cartResponse?.currencyCode ?? "EGP"))
                            .font(.poppinsFont(size: 16, weight: .bold))
                            .foregroundColor(Color("AccentColor"))
                    }.padding(.horizontal)
                    ...
                    HStack{
                        Text("Discount")
                            ...
                            .foregroundColor(Color("DarkGray"))
                        Spacer()
                        Text(String(viewModel.cartResponse?.discountPercentage ?? 0) + " " + (viewModel.cartResponse?.currencyCode ?? "EGP"))
                            .font(.poppinsFont(size: 16, weight: .bold))
                            .foregroundColor(Color("AccentColor"))
                    }.padding()
                    ...
                    HStack{
                        Text("Total price")
                            ...
                            .foregroundColor(Color("DarkGray"))
                        Spacer()
                        Text(String(viewModel.cartResponse?.total ?? 0) + " " + (viewModel.cartResponse?.currencyCode ?? "EGP"))
                            .font(.poppinsFont(size: 16, weight: .bold))
                            .foregroundColor(Color("AccentColor"))
                    }.padding()
                }.background(
